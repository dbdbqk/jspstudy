...
import service.IBoradService;

@WebServlet("*.do")	// getAllBoardList.do getBoardByNo.do writeBoard.do addBoard.do modifiyBoard.do removeBoard.do
...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/removeBoard.do":
			...
			break;
		case "/writeBoard.do":
			af = new ActionForward("board/write.jsp", false);	// board 폴더 아래 write.jsp로 forward 한다. (단순 이동의 경우 forward한다.)
			break;
		}
