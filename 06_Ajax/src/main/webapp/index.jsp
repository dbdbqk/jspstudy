...
<%
	pageContext.setAttribute("contextPath", request.getContextPath());	// c set에 패쓰 저장이랑 똑같다
%>
	...
	<div class="wrap">
		...
		<form id="frm_member">
			<div>
				...
				<span style="display:none"; id="over">내용</span> 
			</div>
			<div>
			...
			<div>
				...
				<input type="radio" id="femele" name="gender" value="F">
	...
	function fnAddMember(){
		$.ajax({
			...
			error: function(jqXHR){ // jqXHR 객체에는 예외코드(응답코드: 404, 500등)와 예외메시지 등이 저장된다.
					...
					alert(jqXHR.responseText + '(' + jqXHR.status + ')'); // catch의 out.println(msg)이다.
