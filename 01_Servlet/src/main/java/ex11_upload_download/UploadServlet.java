	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		/*
			...
			3. MultipartRequest 클래스를 이용해서 파일 업로드를 처리할 수 있는데, cos.jar가 MulitipartRequest가 클래스를 지원한다.
		*/
		...
		// 업로드 진행하기 (HttpServletRequest request를 이용해서 MulitipartRequest 객체를 생성하면 업로드가 곧바로 진행된다.)
		...
		// 요청 파라미터 (MulitipartRequest mulitipartRequest를 이용해서 파라미터를 가져와야 한다.)
